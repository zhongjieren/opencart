<div id="rgen-contentblocks-rgenN5SsvI" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text">en-gb - No data</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenN5SsvI .contentblock-grid', '#rgen-contentblocks-rgenN5SsvI .contentblock-grid > .cl');
								});
								</script>
