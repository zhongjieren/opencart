<div id="rgen-contentblocks-rgenNsNJV6" class="rgen-contentblocks contentblocks-rg5H1">
		...
		<div class="text-wrp" style="margin-left:50px;">
						...
						<div class="text">Mon - Sun / 9:00AM - 8:00PM</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenNsNJV6 .contentblock-grid', '#rgen-contentblocks-rgenNsNJV6 .contentblock-grid > .cl');
								});
								</script>
