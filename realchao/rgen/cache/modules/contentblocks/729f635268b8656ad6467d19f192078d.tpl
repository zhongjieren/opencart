<div id="rgen-contentblocks-rgenWv2fkm" class="rgen-contentblocks contentblocks-rgQtX">
				...
				<div class="mod-content">
											...
											<div class="rw gt0 mb0">
														<div class="cl cl12 d-xl12 t-xl12 m-xl12 m-sm12 m-xs12 ">
																...
																<div class="contentblock-grid rw eq1 d-eq1 t-eq1 mxl-eq1 msm-eq1 mxs-eq1 gt0 mb10">
																		<div class="cl">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenWv2fkm .contentblock-grid', '#rgen-contentblocks-rgenWv2fkm .contentblock-grid > .cl');
								});
								</script>
