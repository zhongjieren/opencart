<div id="rgen-contentblocks-rgenSRmW0t" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenSRmW0t .contentblock-grid', '#rgen-contentblocks-rgenSRmW0t .contentblock-grid > .cl');
								});
								</script>
