<div id="rgen-contentblocks-rgenaIyBYU" class="rgen-contentblocks contentblocks-rgQtX">
		...
		<div class="text-wrp">
						...
						<div class="text">Lorem ipsum dolor sit amet</div>
								...
								jQuery(document).ready(function($) {
									equalH('#rgen-contentblocks-rgenaIyBYU .contentblock-grid', '#rgen-contentblocks-rgenaIyBYU .contentblock-grid > .cl');
								});
								</script>
