...
INSERT INTO `layout_module` (`layout_id`, `code`, `position`, `sort_order`) VALUES ('1', 'rgen_revslider.set_rgbm8.rg4zC', 'pos_ss', '0');


DELETE FROM `setting` WHERE `code` LIKE '%revslider%';

INSERT INTO `setting` (`store_id`, `code`, `key`, `value`, `serialized`) VALUES ('0', 'rgen_revslider', 'rgen_revslider_R.set_rgbm8.rg4zC', '1', '0');
