<?php
class ControllerAccountSallerorder extends Controller {
	public function index() {
		...
		$this->load->language('account/sallerorder');
		...
		$this->response->setOutput($this->load->view('account/sallerorder_list', $data));
	}
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->response->setOutput($this->load->view('account/sallerorder_info', $data));
		} else {
			$this->document->setTitle($this->language->get('text_order'));
	...
	public function reorder() {
		...
		$this->response->redirect($this->url->link('account/sallerorder/info', 'order_id=' . $order_id));
	}
}