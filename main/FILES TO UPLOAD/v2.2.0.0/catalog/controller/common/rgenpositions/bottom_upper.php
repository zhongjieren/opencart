<?php
class ControllerCommonRgenpositionsBottomUpper extends Controller {
	public function index() {

		/* CONFIG
		=========================*/
		$position_name = 'bottom_upper';
		$position_key  = 'rg_b_up';
		...
		if($this->registry->get('config')->get('theme_default_directory') == DIR_THEME && $this->rgen->rgen_check != false){
