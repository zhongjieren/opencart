<?php
class ControllerCommonRgenPositionsBesideslides extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'pos_sidess');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/place_besideslideshow.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/rgen-positions/place_besideslideshow.tpl', $data);
		}
	}
}